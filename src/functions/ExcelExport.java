...
public class ExcelExport<T> {
    public void export_computers(TableView<T> tableView){
        ...
        try {
            hssfWorkbook.write(new FileOutputStream("C:/Computers.xls"));
            hssfWorkbook.close();
        } catch (IOException e) {
            e.printStackTrace();
        }
     ...
     public void export_printers(TableView<T> tableView){
        ...
        //save excel file and close the workbook
        try {
            hssfWorkbook.write(new FileOutputStream("C:/Printers.xls"));
            hssfWorkbook.close();
        } catch (IOException e) {
            e.printStackTrace();
        }
